...
for checkpoint in ["microsoft/deberta-v3-large","google/electra-large-discriminator", "bert-large-cased","roberta-large"]:
       ...
       for dataset in ["dev", "test"]:
              ...
              evaluate("prediction_pickles/predictions_mean_"+checkpoint_split+"_"+dataset+".pkl", "prediction_pickles/total_clusters_"+checkpoint_split+"_"+dataset+".pkl")
              print("When selecting the minimum of the cosine distance")
              evaluate("prediction_pickles/prediction_min_"+checkpoint_split+"_"+dataset+".pkl", "prediction_pickles/total_clusters_"+checkpoint_split+"_"+dataset+".pkl")
              print("When selecting the mean of the cosine distance")
              evaluate("prediction_pickles/prediction_euc_mean_"+checkpoint_split+"_"+dataset+".pkl", "prediction_pickles/total_clusters_"+checkpoint_split+"_"+dataset+".pkl")
              print("When selecting the minimum of the euclidean distance")
              evaluate("prediction_pickles/prediction_euc_min_"+checkpoint_split+"_"+dataset+".pkl", "prediction_pickles/total_clusters_"+checkpoint_split+"_"+dataset+".pkl")
